...
'''
Below classes were slightly modified, but provided by:
    Title: Algorithms for Automated Driving
    Author: Mario Theers
    Date: November 21, 2020
    Availability: https://github.com/thomasfermi/Algorithms-for-Automated-Driving/blob/master/code/solutions/control/pure_pursuit.py
'''
