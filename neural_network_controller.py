...
def main():
    ...
    try:
        ...
        visualization_cam = world.spawn_actor(visualization_bp,carla.Transform(carla.Location(x=1.5,y=0, z=2), carla.Rotation(pitch=-15, yaw=0)),
            attach_to=vehicle)
        ...
        visualization_cam_left = world.spawn_actor(visualization_bp,carla.Transform(carla.Location(x=1.5,y=0, z=2), carla.Rotation(pitch=-15, yaw=15)),
            attach_to=vehicle)
        ...
        visualization_cam_right = world.spawn_actor(visualization_bp,carla.Transform(carla.Location(x=1.5,y=0, z=2), carla.Rotation(pitch=-15, yaw=-15)),
            attach_to=vehicle)
        ...
        with CarlaSyncMode(world, *sensors, fps=FPS) as sync_mode:
            while frame <= 4000: #equal to one loop around the track
                ...
                throttle, steer = controller.get_control(traj_prediction, speed, desired_speed=10, dt=1./FPS)
